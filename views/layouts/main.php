...
<?php $this->beginPage() ?>
<!DOCTYPE html>
<!-- Copyright (c) Vitalii Potapov | https://fast-pass.vitaliipotapov.ru/ -->
...
<footer class="footer">
    <div class="container">
        <p class="pull-left copyrigth"><a title="All rights reserved">&copy;</a> <a href="https://fast-pass.vitaliipotapov.ru/">Vitalii Potapov</a> <a title="First publication 2019.5.17"><?=date('Y')?></a></p>
    </div>
</footer>
