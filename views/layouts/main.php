        ...
        <div class="toolbar-modal" tabindex="-1">
            <div class="toolbar">
                ...
                <div class="container width-sm-100">
                    ...
                    <a id="add-google-auth" data-toggle="modal" data-target="#google-auth-modal">Add Google Authorization</a>
...
<footer class="footer">
    <div class="container">
        <p class="pull-left copyrigth"><a title="All rights reserved">&copy;</a> <a href="https://quick-login.vitaliipotapov.ru/">Vitalii Potapov</a> <a title="First publication 2019.5.17"><?=date('Y')?></a></p>
    </div>
</footer>
